...
const footerLinks = {
  aesthetic: [
    { href: "/botox-dubai", label: "Botox" },
    { href: "/dermal-fillers-dubai", label: "Dermal Fillers" },
    { href: "/skin-rejuvenation-dubai", label: "Skin Rejuvenation" },
    { href: "/prp-treatment-dubai", label: "PRP" },
    { href: "/thread-lift-dubai", label: "Thread Lift" },
    { href: "/fat-melting-treatment-dubai", label: "Fat Melting" },
    { href: "/skin-boosters-dubai", label: "Skin Boosters" },
  ],
  medical: [
    { href: "/aesthetic-treatments", label: "General Practice" },
    { href: "/aesthetic-treatments#medical", label: "Male Health" },
    { href: "/aesthetic-treatments#medical", label: "Chronic Disease Management" },
    { href: "/aesthetic-treatments#minor-surgery", label: "Minor Surgery" },
    { href: "/minor-aesthetic-procedures-dubai", label: "Minor Procedures" },
  ],
  clinic: [
    { href: "/about-us", label: "About Visage" },
    { href: "/aesthetic-doctor-dubai", label: "Our Doctor" },
