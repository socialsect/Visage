          ...
          <div className="lg:col-span-4">
            ...
            <div className="mt-6 flex items-center gap-4">
              ...
              {["Instagram", "Facebook", "TikTok"].map((platform) => (
                <span
                  key={platform}
                  className="flex h-8 w-8 items-center justify-center rounded-full border border-warm-300 text-[10px] font-medium text-warm-500 transition-colors hover:border-brand-300 hover:text-brand-600"
                  title={platform}
                >
                  {platform[0]}
                </span>
